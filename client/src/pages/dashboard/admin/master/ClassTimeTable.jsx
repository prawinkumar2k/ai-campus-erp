  ...
  useEffect(() => {
    const fetchInitialData = async () => {
      try {
        ...
        setDepartments(toArray(deptData));
        setSemesters(toArray(semData));
        setYears(toArray(yearsData));
        setRegulations(toArray(regData));
      } catch (error) {
            ...
            <div className="col-12 col-md-4">
              ...
              >
                ...
                {courses.map((course, i) => (
                  <option key={course._id || course.courseName || i} value={course.courseName}>
                    {course.courseName}
                  </option>
                ))}
              </select>
